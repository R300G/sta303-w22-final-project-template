...
The Binomial Generalized Linear Model is given by:
...
#lrtest(m4,m5)
#lrtest(m4,m6)
kbl(broom::tidy(m4)[,], caption = "Summary Table of The Generalized Linear Model", 
      digits = 3, format = "markdown", align = "ccccc", padding= 3)
```

```{r, echo = FALSE, message=FALSE}
## load confidence interval
dev_Confint <- confint(m4,method="Wald")
kable(dev_Confint,  caption = "Confidence Interval Table of The Generalized Linear Model", digits = 3, format = "markdown", align = "ccccc", padding= 3)
```
...
```{r, echo = FALSE}
kbl(broom::tidy(m2)[,], caption = "Summary Table of The Bionomial Generalized Linear Model", 
      digits = 3, format = "markdown", align = "ccccc", padding= 3)
```
...
```{r, echo = FALSE, message=FALSE}
## load confidence interval
dev_Confint <- confint(m2,method="Wald")
kable(dev_Confint,  caption = "Confidence Interval Table of The Binomial Generalized Linear Model", digits = 3, format = "markdown", align = "ccccc", padding= 3)
```
...
kbl(broom.mixed::tidy(m2,effects="fixed")[,], caption = "Summary Table of The Poisson Generalized Linear Mixed Model", 
      digits = 3, format = "markdown", align = "ccccc", padding= 3)
```
...
## load confidence interval
dev_Confint <- confint(m2,method="Wald")
kable(dev_Confint,  caption = "Confidence Interval Table of The Poisson Generalized Linear Mixed Model", digits = 3, format = "markdown", align = "ccccc", padding= 3)
```

For a Poisson generalized linear mixed model to be valid, following assumptions needs to hold.

1. The model's response needs to be under Poisson distribution. 

Flags is a count variable that records the number of red flags over the period of user's sleep time, thus falls under Poisson distribution.
...
4. The model assumes a linear relationship between the transformed response with the predictor variables. Which in this case is $log(Flags)$ and $emoji \\color$.
